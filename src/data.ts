...
export const STORAGE_KEY = 'cronograma-lunding-v1'
export const THEME_KEY = 'cronograma-theme'

/** Tipos de tarea disponibles y su color de badge. */
export const TIPOS: { tipo: string; bc: BadgeClass }[] = [
  { tipo: 'Fotos', bc: 'b-fotos' },
  { tipo: 'Dominio/Hosting', bc: 'b-dominio' },
  { tipo: 'Desarrollo', bc: 'b-desarrollo' },
  { tipo: 'Documentación', bc: 'b-doc' },
  { tipo: 'Onboarding', bc: 'b-onboarding' },
  { tipo: 'Info', bc: 'b-info' },
]

export const bcForTipo = (tipo: string): BadgeClass =>
  TIPOS.find((t) => t.tipo === tipo)?.bc ?? 'b-info'

export const defaultDays: Day[] = [
  {
    id: 'd0',
    label: 'Lunes 8 junio',
    focus: 'Solicitudes + dominios',
    tasks: [
  ...
  {
    id: 'd1',
    label: 'Martes 9 junio',
    focus: 'Hosting + fotos propias',
    tasks: [
  ...
  {
    id: 'd2',
    label: 'Miércoles 10 junio',
    focus: 'Desarrollo ligero',
    tasks: [
  ...
  {
    id: 'd3',
    label: 'Jueves 11 junio',
    focus: 'Desarrollo pesado + onboarding',
    tasks: [
  ...
  {
    id: 'd4',
    label: 'Viernes 12 junio',
    focus: 'Cierre + documentación',
    tasks: [
...
export const cloneDays = (): Day[] => JSON.parse(JSON.stringify(defaultDays))
